...
class ErrorToast extends Toast {
  constructor(message, err, duration, action = "") {
    message += ": " + err;
    super(message, "default", duration, require("./assets/error-icon.svg"), action);
  }
}
class WarningToast extends Toast {
  constructor(message, duration, action = "") {
    super(message, "default", duration, require("./assets/warning-icon.svg"), action);
  }
}
class SuccessToast extends Toast {
  constructor(message, duration, action = "") {
    super(message, "default", duration, require("./assets/success-icon.svg"), action);
  }
}
/** POPUP **/
...
function placeholderToast() {
  return new Toast(
    ...
    "default",
    1500,
    require("./assets/unimplemented-icon.svg")
  );
}
//! placeholder action
